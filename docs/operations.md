...
`orbit-gfx-ray-scope` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for ray systems, covering stream reduction, windowed input fixtures, and failure-oriented tests.
