...
- `baseline`: `geometry span`, score 243, lane `ship`
- `stress`: `atlas pressure`, score 246, lane `ship`
- `edge`: `shader drift`, score 191, lane `ship`
- `recovery`: `render budget`, score 148, lane `ship`
- `stale`: `geometry span`, score 180, lane `ship`
